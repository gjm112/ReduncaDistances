...
cd /Users/gregorymatthews/Dropbox/ReduncaDistancesGit/code/matlab
...
for t=1:6
        ...
        data_fulvorufula = readtable(wd + "/ReduncaDistancesGit/data/matlab/data_"+toothtype(t)+"_fulvorufula.csv")
data=[data_darti; data_arundinum; data_fulvorufula] 
        ...
        save(wd + "/ReduncaDistancesGit/data/matlab/pairwise_distances_"+toothtype(t)+".mat","ddd")
        csvwrite(wd + "/ReduncaDistancesGit/data/matlab/pairwise_distances_"+toothtype(t)+".csv",ddd)
